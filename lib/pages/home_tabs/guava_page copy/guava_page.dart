                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const GuavaObservationPage(),
                          ),
                        );
                      },
                      ...
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) =>
                                    const GuavaDiseasePage(), // ✅ 前往 guava_disease.dart
                          ),
                        );
                      },
                      borderRadius: BorderRadius.circular(12),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: const [
                ...
                SizedBox(height: 8),
                Text(
                  '本平台致力於提升彰化芭樂產區的智慧化管理能力，透過感測設備、即時數據與預測技術，提供農民便捷的數位工具與決策依據。',
                  style: TextStyle(
                    fontSize: 14,
